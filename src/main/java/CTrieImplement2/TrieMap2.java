...
import static CTrieImplement2.LookupResult.RESTART;
 ...
 */
public abstract class TrieMap2<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K,V>, Serializable {
    ...
    TrieMap2(final Equivalence<? super K> equiv) {
        this.equiv = equiv;
    }
